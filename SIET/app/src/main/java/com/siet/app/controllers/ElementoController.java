...
public class ElementoController {
    ...
    public String registrarPost(ElementoViewModel elementoViewModel){
        ...
        elementoViewModel.mensajesb.add("Elemento CREADO correctamente.");
        return "elemento/ingresar";
    ...
    public String eliminarPost(ElementoViewModel elementoViewModel) {
        ...
        if (elmSearchedOptional.isPresent()) {
            ...
            elementoViewModel.mensajesb.add("El ELEMENTO se ELIMINO correctamente.");
            return "elemento/buscar";
        } else {
    ...
    public String actualizarPost(ElementoViewModel elementoViewModel) {
        ...
        if (elmSearchedOptional.isPresent()) {
            ...
            if(validation){
                elementoViewModel.mensajesb.add("El ELEMENTO fue ACTUALIZADO correctamente.");
                return "elemento/buscar";   
            }
    ...
    @RequestMapping(value = "informes", method = RequestMethod.POST)
    public String informesFiltro(ElementoViewModel elementoViewModel) {

        
        if(elementoViewModel.getIdEstado() == '0'){
            ...
            Optional<Elemento> elmSearchedOptional = elmRepo.findByIdEstado(elementoViewModel.getIdEstado());
        ...
        if (!elmSearchedOptional.isPresent()) {
            elementoViewModel.mensajes.add("NO se encuentran ELEMENTOS con el criterios solicitado.");
            return "elemento/informes";
        }
